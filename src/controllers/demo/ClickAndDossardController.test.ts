/**
 * Unit-tests for the ClickAndDossardController
 *
...
import TestServer from '../shared/ClickAndDossardServer.test';
import ClickAndDossardController from './ClickAndDossardController';


describe('ClickAndDossardController', () => {

    const demoController = new ClickAndDossardController();
    ...
    describe('API: "/api/say-hello/:name"', () => {
        ...
        const { SUCCESS_MSG } = ClickAndDossardController;
