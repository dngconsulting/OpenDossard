            ...
            ({competition, currentRace, rows, fetchRows, fetchCompetition}) => {
                ...
                const exportPDF = async () => {
                    ...
                    _.orderBy(filterByRace(rows, currentRace), ['riderNumber'], ['asc']).forEach((r:RaceRow,index:number)=>{
                        rowstoDisplay.push([_.padStart(r.riderNumber.toString(), 3, '0'),r.name,r.club,r.dept,r.gender,r.catev,r.catea])
                    })
                    let doc = new jsPDF("p","mm","a4");
                    // @ts-ignore
                    var totalPagesExp = '{total_pages_count_string}'
                    // @ts-ignore
                    doc.autoTable({head: [['Doss.', 'Nom et Prénom', 'Club','Dpt','Sexe','Caté','Cat.2']], columnStyles: {
                            0: {columnWidth: 13},
                            1: {columnWidth: 65},
                            2: {columnWidth: 65},
                            3: {columnWidth: 12},
                        ...
                        didDrawPage: (data:any) => {
                            ...
                            addWrappedText({
                                text: 'Coureurs engagés - ' + competition.name  + ' - Caté. ' + currentRace, // Put a really long string here
                                textWidth: 140,
                                fontSize:14,
                                doc,
