    ...
    return (
        <Container style={{marginTop: '2rem'}}>
            <Grid container={true} spacing={2} alignItems={'center'}>
                ...
                <Grid item={true} xs={4} style={{marginTop: '2rem'}}>
                    <Autocomplete value={{label: props.mainInfos.competitionType  || '', value: props.mainInfos.competitionType || ''}}
                                  ...
                                  onChange={(event: any, target: string|any) => {
                                      ...
                                      const mainInfoError = showEmptyFields();
                                      if(target) {
                                          props.updateMainInfos({...props.mainInfos, competitionType: target.value}, mainInfoError);
                                      } else {
                                          props.updateMainInfos({...props.mainInfos, competitionType: null}, mainInfoError);
                                      }
                                  }}
                ...
                <Grid item={true} xs={4} style={{marginTop: '2rem'}}>
                    <Autocomplete value={props.mainInfos.info}
                                  ...
                                  onChange={(event: any, target: string|any) => {
                                      const mainInfoError = showEmptyFields();
                                      props.updateMainInfos({...props.mainInfos, info: target}, mainInfoError);
                                  }}
                                  options={['Valloné', 'Montagne', 'Circuit Plat', 'Moy-Montagne', 'NC']} />
                </Grid>
                <Grid item={true} xs={4} style={{marginTop: '2rem'}}>
                    <Autocomplete value={{ label: props.mainInfos.fede || "", value: props.mainInfos.fede || "" }}
                                  getOptionLabel={(option) => option.label}
                                  getOptionSelected={(option, target) => option.value === target.value}
                                  autoComplete={true}
                                  autoSelect={true}
                ...
                <Grid item={true} xs={8} style={{marginTop: '2rem'}}>
                    { props.mainInfos.fede && props.mainInfos.fede !== FedeEnum.NL &&
                    <ClubSelect isError={error.club}
                ...
                {props.mainInfos.id ?
                    <Grid container={true} spacing={2} alignItems={'center'}>
                        ...
                        <Grid item={true} xs={12} style={{marginTop: '2rem'}}>
