...
export const RacesCtrlApiFp = function(configuration?: Configuration) {
    return {
        ...
        _delete(id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
            const localVarFetchArgs = RacesCtrlApiFetchParamCreator(configuration)._delete(id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response;
...
export const RacesCtrlApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        _delete(id: string, options?: any) {
            return RacesCtrlApiFp(configuration)._delete(id, options)(fetch, basePath);
        },
        /**
         * 
         * @param {RaceCreate} [body] 
...
export class RacesCtrlApi extends BaseAPI {
    ...
    public _delete(id: string, options?: any) {
        return RacesCtrlApiFp(this.configuration)._delete(id, options)(this.fetch, this.basePath);
    }
