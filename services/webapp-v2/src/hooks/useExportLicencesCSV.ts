...
import { licencesCSV } from '@/utils/csv/licences-csv';
...
interface UseExportLicencesCSVResult {
...
/**
 * Hook to export filtered licences to CSV
 ...
 */
export function useExportLicencesCSV(
  params: PaginationParams,
  totalCount: number
): UseExportLicencesCSVResult {
