...
export const FEDERATIONS: Record<FedeEnum, Federation> = {
  ...
  [FedeEnum.FFC]: {
    ...
    catev: [
      ...
      { label: 'Open 1 (VTT/CX)', value: 'OPEN1VTT', competitionTypes: ALL_COMPETITION_TYPES },
      ...
      { label: 'Junior (U19)', value: 'U19', competitionTypes: ALL_COMPETITION_TYPES },
      { label: 'Cadet (U17)', value: 'U17', competitionTypes: ALL_COMPETITION_TYPES },
      { label: 'Minimes (U15)', value: 'U15', competitionTypes: ALL_COMPETITION_TYPES },
